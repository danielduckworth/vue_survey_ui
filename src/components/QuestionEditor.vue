<template>
  ...
  <div class="grid gap-3 grid-cols-12">
    <div class="mt-3 col-span-9">
      <label :for="'question.text' + model.data">Question text</label>
      <input
        type="text"
        name="'question.text' + model.data"
    ...
    <div v-if="shouldHaveOptions()" class="mt-2">
      ...
      >
        ...
        <button
          ...
          class="h-6 w-6 rounded-full flex items-center justify-center border border-transparent transition-color hover:border-red-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
...
const model = reactive(JSON.parse(JSON.stringify(props.question)));
